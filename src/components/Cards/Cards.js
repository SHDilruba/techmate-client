          ...
          <div className="card-body items-center text-center">
           ...
           <div className="px-1 text-[0.9rem]"><p>{children.description}</p></div>
            ...
            <div className="bg-white rounded-lg">
                <p className="text-[1.1rem] font-semibold py-[0.6rem] text-secondary px-6">
            ...
            className="btn btn-secondary ml-1 bg-gradient-to-l from-secondary to-accent rounded-lg text-white border-white hover:border-2 hover:border-secondary"
          > BOOK NOW 
         </label>
            </div>
          </div>
