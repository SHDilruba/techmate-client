          ...
          <div className='bg-accent pb-16 px-8 w-[30rem] rounded-2xl'>
            <div className="modal-action">
             ...
             <form onSubmit={handleBooking} className='grid grid-cols-1 gap-3 mt-10 '>
                  ...
                  <input name="resale_price" type="text" defaultValue={content.content.resale_price} className="input w-full outline bordered" disabled placeholder="Product Price" />
                  ...
                  <input className='btn btn-secondary w-full outline' type="submit" value="Confirm to Booking" />
              </form>
            </div>
         </div>
    </div>
